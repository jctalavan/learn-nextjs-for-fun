...
import ParrafoWithTitle from "components/parrafoWithTitle";
...
export default function FirstPost() {
  return (
    <>
      ...
      /> */}
        <h1>Lorem Ipsum</h1>
        <ParrafoWithTitle title="¿Qué es Lorem Ipsum?">
        ...
        <ParrafoWithTitle title="¿De dónde viene?">
